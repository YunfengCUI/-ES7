...
@RestController
@Slf4j
public class EsOutstandingCaseController {
    ...
    public String addOrUpdataIndexData(@ApiParam(value = "my_1012",readOnly = true)String index, EsOutstandingCase esOutstandingCase ){
        return esEntityService.addData(IndexName,esOutstandingCase);
    }
    ...
    public RestStatus bulkAdd_UpdateDocument(String indexName, ArrayList<EsOutstandingCase> esOCArrayList ){
    ...
    public Object search(@RequestBody EsOutstandingCase esOutstandingCase ){
        System.out.println(esOutstandingCase);
        return esEntityService.search(IndexName,esOutstandingCase,esOutstandingCase.getFormNo(), esOutstandingCase.getFormSize());
    }
