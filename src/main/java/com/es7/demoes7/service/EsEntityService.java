...
//    取决于 实体id
    ...
    String addData(String indexName, EsOutstandingCase esOutstandingCase);
//    获取单条数据
...
//    boolean updateDocument(String indexName,EsAuditBasy esAuditBasy);
    ...
    //批量导入数据
    RestStatus bulkAdd_Update_EsOutstandingCase_Document(String indexName, ArrayList<EsOutstandingCase> esAuditBasyArrayList);

    //    查询数据 优秀案例
    Object search(String indexName, EsOutstandingCase esOutstandingCase, Integer formNo, Integer formSize);
